...
<Modal
    ...
    <View
      ...
      <TouchableOpacity
        ...
        <Text style={{ color: '#307ecc', paddingVertical: 10, fontSize: 16,  alignSelf: 'center',}}>FINISH</Text>
      </TouchableOpacity>
      ...
      <View style={{ alignItems: 'center' }}>
        <Text style={{alignSelf: 'center', fontSize: 20, color: 'gray',marginTop:20}}>
            Uploaded File/s
          </Text>
        <FlatList
